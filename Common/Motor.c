...
static void MOT_PrintHelp(const CLS1_StdIOType *io) {
  ...
  CLS1_SendHelpStr((unsigned char*)"  stop", (unsigned char*)"stops motor immediately\r\n", io->stdOut);
}
...
//	/* We could deinit the motor*/
//	  motorL.DirPutVal = DirLPutVal(1);
//	  motorR.DirPutVal = DirRPutVal(1);
