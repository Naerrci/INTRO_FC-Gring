...
#ifndef EVENT_STYGER_H_
#define EVENT_STYGER_H_
 ...
 */
void EVNT_SetEvent_Sty(EVNT_Handle event);

/*!
 * \brief Clears an event.
 * \param[in] event The event handle of the event to clear.
 */
void EVNT_ClearEvent_Sty(EVNT_Handle event);
...
void EVNT_Init_Sty(void);

/*! \brief Event module de-initialization */
void EVNT_Deinit_Sty(void);
